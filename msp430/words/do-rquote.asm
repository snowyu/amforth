...
XT_DORQUOTE: DW      DOCOLON
        DW XT_R_FETCH,IFETCH
        DW XT_R_FROM,XT_CELLPLUS,XT_DUP,ICFETCH,CHARPLUS
        DW XT_2DUP,XT_PLUS,ALIGNED,XT_TO_R
        DW XT_TO_R,XT_OVER,XT_R_FROM,ITOD,XT_ICOUNT,XT_EXIT
