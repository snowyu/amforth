# -*- coding: utf-8 -*-
#
# AmForth documentation build configuration file, created by
...
man_pages = [
    ('index', 'amforth', u'AmForth Documentation',
     [u'Matthias Trute'], 1)
]
...
texinfo_documents = [
  ('index', 'AmForth', u'AmForth Documentation',
   u'Matthias Trute', 'AmForth', 'One line description of project.',
   'Miscellaneous'),
]
